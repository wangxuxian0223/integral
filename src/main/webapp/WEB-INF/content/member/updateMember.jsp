...
<body>
	...
	<script type="text/javascript"
		src="${pageContext.request.contextPath }/js/member/updateMember.js"></script>

	<form id="memberForm" method="post">
		<fieldset>
			<legend>会员基本信息</legend>
			<table align="center">
				<input type="hidden" id="memcardsId" name="memcardsId" value="${param.param1 }"/>
				<tr>
				...
				<!-- <tr>
					<td>是否设置过期时间：<input data-val="true"
						...
						name="memcardsIspast" type="radio" value="1" />是<input
						name="memcardsIspast" checked="True" type="radio" value="0" />否
						</td>
				</tr> -->
				<!-- <tr>
				...
				<!-- <tr>
					<td>积分是否可以自动转换成等级：<input data-val="true" checked="True"
						data-val-required="MC_IsPointAuto 字段是必需的。" id="memcardsIspointauto"
						name="memcardsIspointauto" type="radio" value="1" /><input
						name="memcardsIspointauto" type="radio" value="0" /></td>
				</tr> -->
				<tr>
				...
				<tr>
					<td colspan="2" align="center">
						<a id="btnCon" href="javascript:void(0)" class="easyui-linkbutton" data-options="iconCls:'icon-save'">修改</a>
